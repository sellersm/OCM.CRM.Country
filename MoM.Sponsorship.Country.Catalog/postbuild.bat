...
xcopy "C:\MissionOfMercy\CRM\Source\MoM.Sponsorship.Country\MoM.Sponsorship.Country.Catalog\bin\Release\MoM.Sponsorship.Country.Catalog.dll" "C:\MissionOfMercy\CRM\Releases\DEV\Catalog Assemblies" /y /d
